      ...
      output: {
        manualChunks: {
          ...
          ['intl']: [
            ...
            '@formatjs/intl-numberformat/locale-data/nb.js',
            '@formatjs/intl-numberformat/locale-data/nn.js',
            '@formatjs/intl-numberformat/locale-data/en.js',
            '@formatjs/intl-datetimeformat',
            '@formatjs/intl-datetimeformat/locale-data/nb.js',
            '@formatjs/intl-datetimeformat/locale-data/nn.js',
            '@formatjs/intl-datetimeformat/locale-data/en.js',
