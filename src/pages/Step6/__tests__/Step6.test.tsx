...
describe('Step 6', () => {
  ...
  it('sender tilbake til steg 5 når brukeren som mottar uføretrygd og som har valgt afp, klikker på Tilbake', async () => {
    ...
    await stateStore.dispatch(apiSlice.endpoints.getUfoeregrad.initiate())
  ...
  it('sender tilbake til steg 4 når brukeren som ikke mottar uføretrygd og som har valgt noe annet enn har valgt AFP offentlig, klikker på Tilbake', async () => {
    const user = userEvent.setup()
