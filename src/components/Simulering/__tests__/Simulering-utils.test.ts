  ...
  describe('processPensjonsavtalerArray', () => {
    ...
    it('returnerer riktig summer basert på fødselsmaaned med en eller flere avtaler, eller med flere utbetalingsperioder', () => {
      ...
      expect(
        ...
        0, 58333.333333333336, 100000, 100000, 158333.33333333334, 200000,
    ...
    it('returnerer riktig summer med graderte avtaler, eller graderte utbetalingsperioder', () => {
      ...
      expect(
        ...
        0, 29166.666666666668, 50000, 50000, 112500, 150000, 150000, 150000,
        150000, 200000, 225000, 191666.6666666667, 108333.33333333334, 75000,
      ])
    })
    describe('returnerer riktig summer basert på startMaaned og sluttMaaned', () => {
      it('med en avtale', () => {
        expect(
          ...
          100000, 100000, 33333.333333333336, 0,
        ])
        expect(
          processPensjonsavtalerArray(66, 13, '1963-04-30', [
            createMockedPensjonsavtale({
      ...
      it('med flere avtaler (livsvarige og graderte)', () => {
        expect(
          ...
          0, 50000, 100000, 100000, 166666.6666666667, 200000, 200000, 200000,
          200000, 200000, 200000, 133333.33333333334, 33333.333333333336,
        ])
        expect(
          processPensjonsavtalerArray(66, 13, '1963-04-30', [
            createMockedPensjonsavtale({
          ...
          0, 66666.66666666667, 200000, 200000, 200000, 200000, 200000, 200000,
        ...
        expect(
          ...
          0, 83333.33333333334, 150000, 150000, 216666.6666666667, 250000,
          250000, 250000, 250000, 262500, 325000, 275000, 191666.6666666667,
        ])
      })
