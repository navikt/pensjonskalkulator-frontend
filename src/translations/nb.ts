const translations = {
  ...
  'stegvisning.endring.alert':
    'Du har pensjon. Vil du sjekke hva kan få hvis du endrer uttaket, må du gå til <detaljertKalkulatorLink>detaljert pensjonskalkulator</detaljertKalkulatorLink>.',
