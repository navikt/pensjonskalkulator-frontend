const translations = {
  ...
  'stegvisning.steg2.ingress':
    'Du ser alderspensjon (NAV). For å se pensjon fra arbeidsgivere må vi ha ditt samtykke for å hente pensjonsavtalene dine.',
  'stegvisning.steg2.readmore_title': 'Disse opplysningene henter vi',
  'stegvisning.steg2.readmore_ingress':
  ...
  'stegvisning.steg2.readmore_list_title': 'Samtykket:',
  'stegvisning.steg2.readmore_list_item1':
    'innebærer at vi henter opplysninger om pensjonsavtaler i privat sektor fra Norsk Pensjon.',
  'stegvisning.steg2.readmore_list_item2':
  ...
  'stegvisning.steg2.readmore_list_item3':
