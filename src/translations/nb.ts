const translations = {
  ...
  'beregning.vilkaarsproeving.alternativer.heltUttak':
    'Ett alternativ er at du ved {alternativtHeltStartAar} år og {alternativtHeltStartMaaned} måneder ta ut <nowrap>100 %</nowrap> alderspensjon. Prøv gjerne andre kombinasjoner.',
  'beregning.vilkaarsproeving.alternativer.gradertUttak':
    'Ett alternativ er at du ved {alternativtGradertStartAar} år og {alternativtGradertStartMaaned} måneder ta ut <nowrap>{alternativtGrad} %</nowrap> alderspensjon. Prøv gjerne andre kombinasjoner.',
  'beregning.vilkaarsproeving.alternativer.heltOgGradertUttak':
    'Ett alternativ er at du ved {alternativtGradertStartAar} år og {alternativtGradertStartMaaned} måneder ta ut <nowrap>{alternativtGrad} %</nowrap> alderspensjon hvis du tar ut 100 % alderspensjon ved {alternativtHeltStartAar} år og {alternativtHeltStartMaaned} måneder eller senere. Prøv gjerne andre kombinasjoner.',
