const translations = {
  ...
  'stegvisning.start.endring.ingress.pre2025_offentlig_afp_fremtidig':
    'Du har nå <strong>0 % alderspensjon</strong>. Du har endret til <strong>{grad} % alderspensjon fra {fom}</strong>. Du kan ikke gjøre en ny beregning her før denne datoen.',
