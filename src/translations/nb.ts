const translations = {
  ...
  'stegvisning.stegvisning.samtykke.ingress':
    'Du ser alderspensjon (NAV). For å se pensjon fra arbeidsgivere må vi ha ditt samtykke for å hente pensjonsavtalene dine.',
  'stegvisning.stegvisning.samtykke.readmore_title':
    'Disse opplysningene henter vi',
  'stegvisning.stegvisning.samtykke.readmore_ingress':
  ...
  'stegvisning.stegvisning.samtykke.readmore_list_title': 'Samtykket:',
  'stegvisning.stegvisning.samtykke.readmore_list_item1':
    'innebærer at vi henter opplysninger om pensjonsavtaler i privat sektor fra Norsk Pensjon.',
  'stegvisning.stegvisning.samtykke.readmore_list_item2':
  ...
  'stegvisning.stegvisning.samtykke.readmore_list_item3':
  ...
  'stegvisning.stegvisning.samtykke.radio_label':
    'Skal vi hente dine pensjonsavtaler?',
  'stegvisning.stegvisning.samtykke.radio_ja': 'Ja, hent mine avtaler',
  'stegvisning.stegvisning.samtykke.radio_nei':
    'Nei, fortsett kun med alderspensjon',
  'stegvisning.stegvisning.samtykke.validation_error':
