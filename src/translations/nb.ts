const translations = {
  ...
  'beregning.read_more.pensjonsalder.body':
    'Din opptjening i folketrygden bestemmer når du kan ta ut alderspensjon. Aldersgrensene vil øke gradvis fra 1964-kullet med én til to måneder per årskull.{br}{br}Hvis du har oppgitt AFP og/eller utenlandsopphold, er dette med i vurderingen av når du kan ta ut alderspensjon.{br}{br}Hvis du ikke kan ta ut hel <nowrap>(100 %)</nowrap> alderspensjon fra ønsket alder, kan du endre uttaksgraden for å se om du kan starte tidligere. Tar du ut gradert pensjon, kan tidspunktet du kan ta ut <nowrap>100 %</nowrap> forskyves.',
  'beregning.read_more.pensjonsalder.endring.body':
    'Opptjeningen din i folketrygden bestemmer hvor mye alderspensjon du kan ta ut. Ved {ubetingetUttaksalder} må pensjonen minst tilsvare garantipensjon. Uttak før {ubetingetUttaksalder} betyr at du fordeler pensjonen din over flere år, og dermed får du mindre hvert år.{br}{br}Hvis du har AFP, er AFP med i vurderingen av hvor mye alderspensjon du kan ta ut.',
  'beregning.alt_tekst': 'Årlig inntekt og pensjon etter uttak i kroner.',
  'omufoeretrygd.hel.ingress':
    'Du har <nowrap>100 %</nowrap> uføretrygd. Her kan du beregne <nowrap>100 %</nowrap> alderspensjon fra <nowrap>{ubetingetUttaksalder}</nowrap>. Kommende lovendringer vil gradvis øke pensjonsalderen for dem som er født i 1964 eller senere.',
  'omufoeretrygd.gradert.ingress':
    'Du har <nowrap>{grad} %</nowrap> uføretrygd. Her kan du beregne <nowrap>100 %</nowrap> alderspensjon fra <nowrap>{ubetingetUttaksalder}</nowrap>. Vil du beregne uttak før <nowrap>{ubetingetUttaksalder}</nowrap>, må du gå til {link}. {br}{br}Kommende lovendringer vil gradvis øke pensjonsalderen for dem som er født i 1964 eller senere.',
  'omufoeretrygd.readmore.title': 'Om pensjonsalder og uføretrygd',
  'omufoeretrygd.readmore.hel.ingress':
    '<nowrap>100 %</nowrap> uføretrygd kan ikke kombineres med alderspensjon. Det er derfor ikke mulig å beregne alderspensjon før <nowrap>{ubetingetUttaksalder}</nowrap> i kalkulatoren. Ved <nowrap>{ubetingetUttaksalder}</nowrap> går <nowrap>100 %</nowrap> uføretrygd automatisk over til <nowrap>100 %</nowrap> alderspensjon. Har du spørsmål, kan du kontakte oss på telefon <nowrap>55 55 33 34</nowrap>.',
  ...
  'omufoeretrygd.readmore.gradert.avansert.ingress':
    'Din opptjening i folketrygden bestemmer når du kan ta ut alderspensjon. Ved <nowrap>{ubetingetUttaksalder}</nowrap> må pensjonen minst tilsvare garantipensjon. Uttak før <nowrap>67 år</nowrap> betyr at du fordeler pensjonen din over flere år, og dermed får du mindre hvert år.{br}{br}Ved <nowrap>{ubetingetUttaksalder}</nowrap> går gradert uføretrygd automatisk over til gradert alderspensjon med nærmeste uttaksgrad. Hvis du vil ha <nowrap>100 %</nowrap> alderspensjon må du selv søke om dette.',
  ...
  'forbehold.uforetrygd.ingress':
    'Mottar du uføretrygd, 100 % eller gradert, har vi forutsatt at du beholder lik uføregrad frem til den avsluttes ved {ubetingetUttaksalder}. Hvis du endrer uføregraden din, kan både beregning og valgene dine i kalkulatoren endres.{br}{br}Kalkulatoren legger den antatte inntekten din til grunn. Høyere inntekt blir ikke tatt høyde for i kalkulatoren.{br}{br}Kalkulatoren beregner etter dagens opptjeningsregler for uføretrygd. Kommende lovendringer vil gi deg et annet resultat.',
