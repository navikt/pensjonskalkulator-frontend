const translations = {
  ...
  'landingsside.body.uinnlogget_kalkulator':
    'You can use our unauthenticated calculator. It does not retrieve or store any information about you. You must find and enter all the information yourself. The calculator gives you an estimate of retirement pension pension from the National Insurance Scheme (NAV) and AFP (contractual pension) in the private sector.',
  ...
  'stegvisning.fremtidigvedtak.alert':
    'You have a decision about retirement pension pension but have not started taking it yet. You can calculate a new retirement pension pension here until you start withdrawing.',
  'stegvisning.fremtidigvedtak.endring.alert':
    'You have changed your retirement pension pension but have not started a new withdrawal yet. You can calculate a new change here until you start withdrawing.',
  'stegvisning.start.title': 'Hello',
  'stegvisning.start.endring.ingress':
    'You currently have <strong>{grad} % retirement pension pension</strong>{ufoeretrygd}{afpPrivat}{afpOffentlig}. Here you can check what you can receive if you want to change your retirement pension pension.{br}{br}',
  ...
  'stegvisning.start.list_item1': 'retirement pension pension (NAV)',
  ...
  'stegvisning.utenlandsopphold.ingress':
    'If you have lived or worked more than 5 years outside Norway between the age of 16 and the withdrawal of your pension, it may affect the amount of your retirement pension pension.',
  ...
  'stegvisning.utenlandsopphold.ingress.bottom':
    'If you will not be living in Norway when you receive your pension, you should investigate the rules for export. The calculator does not evaluate whether you have the right to receive your full retirement pension pension if you reside outside Norway.',
  ...
  'stegvisning.samtykke_pensjonsavtaler.ingress':
    'We need your consent to retrieve occupational pension and other pension agreements from employers. If you answer no, you will calculate retirement pension pension (NAV) and any AFP (contractual pension).',
  ...
  'stegvisning.afp.readmore_privat_list_item3':
    'must be taken out together with retirement pension pension from the National Insurance Scheme (NAV)',
  ...
  'stegvisning.afp.readmore_offentlig_list_item3':
    'can be taken out together with retirement pension pension from the National Insurance Scheme (NAV) and occupational pension',
  ...
  'tidligstmuliguttak.ingress_1':
    'Your earnings mean that you can first withdraw <nowrap>100 %</nowrap> retirement pension pension when you are ',
  ...
  'tidligstmuliguttak.info_omstillingsstoenad_og_gjenlevende':
    'retirement pension pension cannot be combined with a survivor´s pension or adjustment benefits. If you wish to withdraw retirement pension pension before 67, you must forfeit the survivor´s pension or adjustment benefit when you withdraw your retirement pension pension. If you have questions, you can contact us at 55 55 33 34.',
  ...
  'beregning.read_more.pensjonsalder.body':
    'The age limits will gradually increase from the 1964 cohort by one to two months per cohort, but this is not accounted for in the pension calculator.{br}{br}Your accrual in the National Insurance Scheme determines when you can withdraw retirement pension pension. By 67, your pension must at least correspond to the guarantee pension. Withdrawing before 67 means that you distribute your pension over multiple years, and thus receive less each year.{br}{br}If you have stated that you have AFP, AFP is included in the assessment of when you can withdraw retirement pension pension.{br}{br}If you cannot take out full <nowrap>(100 %)</nowrap> retirement pension pension from your desired age, you can adjust the withdrawal degree to see if you can start earlier. If you withdraw graded pension, the time you can take out <nowrap>100 %</nowrap> may be postponed.',
  'beregning.read_more.pensjonsalder.endring.body':
    'Your accrual in the National Insurance Scheme determines how much retirement pension pension you can withdraw. By 67, your pension must at least correspond to the guarantee pension. Withdrawing before 67 means that you distribute your pension over multiple years, and thus receive less each year.{br}{br}If you have AFP, AFP is included in the assessment of how much retirement pension pension you can withdraw.',
  'omufoeretrygd.hel.ingress':
    'You have <nowrap>100 %</nowrap> disability benefits. Here you can calculate <nowrap>100 %</nowrap> retirement pension pension from 67 years. Upcoming legal changes will gradually increase the retirement age for those born in 1964 or later.',
  'omufoeretrygd.gradert.ingress':
    'You have <nowrap>{grad} %</nowrap> disability benefits. Here you can calculate <nowrap>100 %</nowrap> retirement pension pension from 67 years. If you want to calculate withdrawal before 67, you must go to {link}. {br}{br}Upcoming legal changes will gradually increase the retirement age for those born in 1964 or later.',
  'omufoeretrygd.readmore.title': 'About Pension Age and Disability Benefits',
  'omufoeretrygd.readmore.hel.ingress':
    '<nowrap>100 %</nowrap> disability benefits cannot be combined with retirement pension pension. Therefore, it is not possible to calculate retirement pension pension before 67 in the calculator. At 67, <nowrap>100 %</nowrap> disability benefits automatically convert to <nowrap>100 %</nowrap> retirement pension pension. If you have questions, you can contact us at 55 55 33 34.',
  'omufoeretrygd.readmore.gradert.ingress':
    'It is possible to combine graded disability benefits and graded retirement pension pension from 62 as long as you have enough accrual to withdraw retirement pension pension. The degree of disability and retirement pension pension cannot exceed <nowrap>100 %</nowrap>. If you have questions, you can contact us at 55 55 33 34.',
  'omufoeretrygd.readmore.gradert.avansert.ingress':
    'Your accrual in the National Insurance Scheme determines when you can withdraw retirement pension pension. By 67, your pension must at least correspond to the guarantee pension. Withdrawing before 67 means that you distribute your pension over multiple years, and thus receive less each year.{br}{br}At 67, graded disability benefits automatically convert to graded retirement pension pension at the nearest withdrawal degree. If you want <nowrap>100 %</nowrap> retirement pension pension, you have to apply for it.',
  'omufoeretrygd.readmore.endring.ingress':
    'Withdrawal degree indicates how much of the monthly retirement pension pension you wish to withdraw. The degree of disability benefits and retirement pension pension can together not exceed 100 %. From 67 years you can freely choose graded withdrawal (20, 40, 50, 60, or 80 %), or full retirement pension pension (100 %).{br}{br}If you want to change the degree, at least 12 months must have passed since you started withdrawing retirement pension pension or changed the withdrawal degree. You can, however, change to 0 % whenever you want.',
  'omufoeretrygd.avansert_link': 'Advanced',
  'velguttaksalder.title':
    'When do you want to withdraw retirement pension pension?',
  'velguttaksalder.endring.title':
    'When do you want to change your retirement pension pension?',
  ...
  'beregning.highcharts.serie.alderspensjon.name':
    'retirement pension Pension (NAV)',
  ...
  'beregning.avansert.endring_banner.title':
    'retirement pension pension before tax when you are ',
  ...
  'beregning.avansert.resultatkort.alderspensjon':
  ...
  'beregning.avansert.rediger.uttaksgrad.label':
    'How much retirement pension pension do you want to withdraw?',
  ...
  'beregning.avansert.rediger.read_more.uttaksgrad.body':
    'Withdrawal degree indicates how much of the monthly retirement pension pension you wish to withdraw. You can choose graded withdrawal (20, 40, 50, 60, or <nowrap>80 %</nowrap>), or full retirement pension pension (<nowrap>100 %</nowrap>).',
  'beregning.avansert.rediger.read_more.uttaksgrad.endring.body':
    'Withdrawal degree indicates how much of the monthly retirement pension pension you wish to withdraw. If you want to change the degree to 20, 40, 50, 60, or 80 %, at least 12 months must have elapsed since you started withdrawing retirement pension pension or changed the withdrawal degree. You can change to 0 % and 100 % as often as you wish.',
  'beregning.avansert.rediger.read_more.uttaksgrad.gradert_ufoeretrygd.body':
    'Withdrawal degree indicates how much of the monthly retirement pension pension you wish to withdraw. The degree of disability benefits and retirement pension pension cannot together exceed 100 %. From 67 years you can freely choose graded withdrawal (20, 40, 50, 60, or 80 %), or full retirement pension pension (100 %).',
  ...
  'beregning.avansert.rediger.uttaksgrad.validation_error':
    'You must choose how much retirement pension pension you wish to withdraw.',
  'beregning.avansert.rediger.uttaksgrad.ufoeretrygd.validation_error':
    'You must lower the withdrawal degree so that the degrees of retirement pension pension and disability benefits do not exceed 100 % together. After 67, you can choose 100 % withdrawal.',
  ...
  'beregning.avansert.rediger.radio.inntekt_vsa_gradert_uttak.ufoeretrygd.description':
    'retirement pension pension does not affect the income limit for your disability benefits.',
  ...
  'beregning.avansert.rediger.inntekt_vsa_gradert_uttak.label':
    'What is your expected annual income while you withdraw <nowrap>{grad} %</nowrap> retirement pension pension?',
  ...
  'beregning.avansert.rediger.agepicker.validation_error':
    ' for when you want to withdraw retirement pension pension.',
  'beregning.avansert.rediger.agepicker.grad.validation_error':
    ' for when you want to withdraw <nowrap>{grad} %</nowrap> retirement pension pension.',
  'beregning.avansert.rediger.agepicker.validation_error.maxAlder':
    'Withdrawal age for <nowrap>100 %</nowrap> retirement pension pension must be later than age for graded pension.',
  'beregning.avansert.rediger.heltuttak.agepicker.label':
    'When will you take out <nowrap>100 %</nowrap> retirement pension pension?',
  ...
  'beregning.vilkaarsproeving.intro.ikke_nok_opptjening':
    '{br}{br}You can earliest withdraw retirement pension pension at 67 years.',
  ...
  'beregning.vilkaarsproeving.alternativer.heltUttak':
    'One alternative is that you can withdraw <nowrap>100 %</nowrap> retirement pension pension at {alternativtHeltStartAar} years and {alternativtHeltStartMaaned} months. Feel free to try other combinations.',
  'beregning.vilkaarsproeving.alternativer.gradertUttak':
    'One alternative is that you can withdraw <nowrap>{alternativtGrad} %</nowrap> retirement pension pension at {alternativtGradertStartAar} years and {alternativtGradertStartMaaned} months. Feel free to try other combinations.',
  'beregning.vilkaarsproeving.alternativer.heltOgGradertUttak':
    'One alternative is that you can withdraw <nowrap>{alternativtGrad} %</nowrap> retirement pension pension at {alternativtGradertStartAar} years and {alternativtGradertStartMaaned} months if you withdraw <nowrap>100 %</nowrap> retirement pension pension at {alternativtHeltStartAar} years and {alternativtHeltStartMaaned} months or later. Feel free to try other combinations.',
  ...
  'beregning.endring.rediger.title':
    'Calculate Change in retirement pension Pension',
  'beregning.endring.rediger.vedtak_status':
    'From {dato} you have received {grad} % retirement pension pension.',
  'beregning.endring.rediger.vedtak_grad_status':
    'You currently have <strong><nowrap>{grad} %</nowrap> retirement pension pension</strong>. ',
  ...
  'grunnlag.sivilstand.ingress':
    'The amount of your retirement pension pension may depend on whether you live alone or with someone. Therefore, if you receive retirement pension pension, you must inform NAV of any changes in marital status. {br}{br}<garantiPensjonLink>About guarantee pension and rates</garantiPensjonLink>',
  ...
  'grunnlag.opphold.ingress.endring':
    'The calculation uses the insurance time you have in Norway from your decision about retirement pension pension.',
  'grunnlag.opphold.bunntekst':
    'When you apply for retirement pension pension, information about time spent outside Norway will be checked against pension authorities in agreement countries. Therefore, your final pension may differ.',
  ...
  'grunnlag.alderspensjon.title': 'retirement pension Pension',
  'grunnlag.alderspensjon.value': 'National Insurance Scheme (NAV)',
  'grunnlag.alderspensjon.ingress':
    'retirement pension pension is calculated based on your pension balance in the National Insurance Scheme. If you continue to have income while withdrawing pension, your retirement pension pension will increase.{br}{br}<dinPensjonBeholdningLink>Your pension accrual</dinPensjonBeholdningLink> {br}{br}<alderspensjonsreglerLink>About the rules for retirement pension pension</alderspensjonsreglerLink>',
  ...
  'grunnlag.afp.ingress.vet_ikke':
    'If you are unsure whether you have AFP, you should ask your employer. AFP can affect when you can withdraw retirement pension pension.',
  ...
  'grunnlag.afp.ingress.ja_offentlig.endring':
    'You have AFP in the public sector. Your AFP is not affected by your change in retirement pension pension. It continues as before.',
  'grunnlag.afp.ingress.ja_privat.endring':
    'You have AFP in the private sector. Your AFP is not affected by your change in retirement pension pension. It continues as before.',
  'grunnlag.afp.ingress.nei.endring':
    'You have indicated that you do not have the right to AFP. If you are unsure whether you have AFP, you should ask your employer. AFP can affect when you can withdraw retirement pension pension.',
  ...
  'inntekt.endre_inntekt_vsa_pensjon_modal.label':
    'Expected Annual Income while withdrawing <nowrap>100 %</nowrap> retirement pension pension',
  'inntekt.endre_inntekt_vsa_pensjon_modal.ingress_2':
    'You can earn as much as you want while withdrawing <nowrap>100 %</nowrap> retirement pension pension.',
  ...
  'inntekt.endre_inntekt_vsa_pensjon_modal.textfield.label':
    'What is your expected annual income while withdrawing <nowrap>100 %</nowrap> retirement pension pension?',
  ...
  'inntekt.info_om_inntekt.ufoeretrygd.read_more.label':
    'About retirement pension pension and the income limit for disability benefits',
  'inntekt.info_om_inntekt.ufoeretrygd.read_more.body':
    'retirement pension pension is not Pensionable income and does not affect the income limit for your disability benefits. You retain your income limit when combining disability benefits and retirement pension pension from the National Insurance Scheme.',
  ...
  'inntekt.info_om_inntekt.ikke_inntekt.list_item1':
    'disability benefits from NAV provide accrual for retirement pension pension but are not Pensionable income',
  ...
  'inntekt.info_om_inntekt.ikke_inntekt.list_item4':
    'Norwegian armed forces (if started no earlier than 2010) provides accrual for retirement pension pension but is not Pensionable income',
  'inntekt.info_om_inntekt.ingress':
    'This list is not exhaustive.{br}{br}Pensionable income matters for the right to and the amount of retirement pension pension and other pension benefits.',
  ...
  'forbehold.gjenlevende.title': 'Survivor"s Pension and Adjustment benefit',
  'forbehold.gjenlevende.ingress':
    'Early withdrawal of retirement pension pension assumes that you have relinquished the survivor"s pension or the adjustment benefit at the time of withdrawal.',
  ...
  'personopplysninger.section.hvordan_brukes.3':
    'The legal basis for processing pension simulation data is Art. 6 (1) c Legal obligation, Administrative Act § 11, National Insurance Act chapter 20 retirement pension Pension, and Art 6 (1) a, Consent. NAV is the data controller for the processing done in the pension calculator.',
  ...
  'personopplysninger.section.hvilke_opplysninger.veiledningsplikt.list.3':
    'Your birth date is retrieved from the National Population Register so that we can calculate your retirement pension pension.',
  'personopplysninger.section.hvilke_opplysninger.veiledningsplikt.list.4':
    'Desired age (year and possibly month) for withdrawal of pension is provided by you so that we can calculate your retirement pension pension.',
  ...
  'personopplysninger.section.hvilke_opplysninger.veiledningsplikt.list.6':
    'Your last pension-eligible annual income (and year) from the Tax Administration is used as income until withdrawal of pension. It is included in the pension balance for calculating your retirement pension pension. If you change future income, your future pension balance will be based on that.',
  ...
  'personopplysninger.section.hvilke_opplysninger.veiledningsplikt.list.8':
    'If you have disability benefits, we use your disability history, degree of disability, estimated income, and any occupational injury history. This is done so that we can calculate your retirement pension pension. We also use the degree of disability to show potential gradations of retirement pension pension that you can withdraw in combination with disability benefits. We do not retrieve medical information from your case.',
  'personopplysninger.section.hvilke_opplysninger.veiledningsplikt.list.9':
    'If you have a survivor’s pension or adjustment benefit, we use this information to inform you that survivor’s pension and adjustment benefit cannot be combined with retirement pension pension.',
  'personopplysninger.section.hvilke_opplysninger.veiledningsplikt.list.10':
    'We ask you about stays outside Norway. We use this information to calculate retirement pension pension with the correct insurance time in Norway. We inquire about the country the stay pertains to and whether you worked in that country to apply the correct social security agreement.',
  'personopplysninger.section.hvilke_opplysninger.veiledningsplikt.list.11':
    'We ask you whether you have a right to AFP in either the public or private sector. We use this information to determine whether we should calculate your retirement pension pension with AFP. This information is also used to inform when you can withdraw your retirement pension pension. Furthermore, we use this information to calculate AFP.',
