const translations = {
  ...
  'stegvisning.start.endring.ingress_1': 'MANGLER_TEKST',
  'stegvisning.start.endring.ingress_2.uten_fremtidig': 'MANGLER_TEKST',
  ...
  'stegvisning.start.endring.ingress_3': 'MANGLER_TEKST',
